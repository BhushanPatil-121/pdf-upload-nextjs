...
export default function Home() {
  ...
  const calculateFileSize = (size: number) => {
    ...
    let fileSize = fileSizeInBytes.toFixed(1); // allowed decimal values up to 1
    ...
    <main className={styles.main}>
      ...
      >
        ...
        <DialogContent>
         ...
         <p> Are you sure you want to delete <span style={{fontWeight:"bold",textDecoration:"underline"}}>{deleteFileName}</span> PFD file ? </p>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={()=> handleDelete(deleteFileName,true)}>Yes</Button>
      ...
      <div className={styles.mainContainer}>
        ...
        <br />
        <h3 className={styles.mainHeading}>select your single pdf</h3>
        <h3 className={styles.mainHeading}>&</h3>
        <h3 className={styles.mainHeading}>Rename pdf name as your preference</h3>
                ...
                <div key={index} style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      fontWeight: "bold",
                      fontSize: "13px",
                    }}>{`${item.fileSize} MB`}</span>
                    <Link href={`/pdffile/${item.fileName}`} target="_top">
                      <Button style={{
                        margin: "5px",
