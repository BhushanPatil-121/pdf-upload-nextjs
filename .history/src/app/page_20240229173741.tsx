...
export default function Home() {
  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>.target: EventTarget & HTMLInputElement) => {
    setDefaultFileName(event.target.files[0].name)
    ...
    if (file) {
      ...
      const f = new File([dataBlob], defaultFileName, { type: dataBlob.type })
