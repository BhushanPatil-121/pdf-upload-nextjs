...
export default function Home() {
  ...
  const [searchPdfFound, setSearchPdfFound] = useState(r)
  ...
  useEffect(() => {
    const getPdfList = async () => {
      ...
      setSearchList(pdfList.fileList)y
    }
    getPdfList()
  }, [loading])
    ...
    <main className={styles.main}>
      ...
      <div className={styles.pdfListContainer}>
        ...
        <div className={styles.pdfListDiv}>
          {
            searchList.length === 0 ?  <PdfListSkeleton /> :
            searchPdfFound.length
